...
/**
    ...
    $parsed_template = websun\websun::websun_parse_template_path( $this->template_data, $this->template_file, $this->template_path );
...
class websun {
    ...
    /**
     * Статический хелпер для быстрого вызова класса.
     ...
     * @return mixed
     */
    public static function websun_parse_template_path($data, $template_path, $templates_root_dir = FALSE, $no_global_vars = FALSE)
    {
        $W = new self([
            'data' => $data,
     ...
     * @return mixed
     */
    public static function websun_parse_template(
        $data,
        $template_code,
